...
const Settings = ({navigation, route}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.settingContainer}>
          ...
          <TouchableOpacity
            style={[
              styles.themeBox,
              {
                ...
                borderWidth: 2,
                borderColor:
                  selectedTheme == 'light' ? Colors.green : Colors.white,
              },
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.themeBox,
              {
                ...
                borderWidth: 2,
                borderColor:
                  selectedTheme == 'dark' ? Colors.green : Colors.accent,
              },
            ]}
        ...
        <Surface style={[Styles.rowView, styles.switchContainer]}>
          <View style={Styles.rowView}>
            ...
            <Text style={[Styles.largeText, {marginLeft: 16}]}>
              Notification
            </Text>
          </View>
          <Switch
      ...
      <Caption style={{textAlign: 'center', marginVertical: 20}}>
        Version 1.0
      </Caption>
    </View>
  );
