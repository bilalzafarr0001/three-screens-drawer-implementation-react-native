...
import PlaceRouteItem from './PlaceRouteItem';
const data = [
  {
    id: '1',
    title: 'Taj Mahal',
  ...
  },
  {
    ...
    title: 'Chichén Itzá',
    image:
      'https://media.tacdn.com/media/attractions-splice-spp-674x446/06/6f/10/a9.jpg',
    favorite: true,
    description:
  ...
  },
  {
    ...
    title: 'Machu Picchu',
    image:
      'https://img.etimg.com/thumb/msid-60341630,width-650,imgsize-63774,,resizemode-4,quality-100/.jpg',
    favorite: true,
    description:
...
const CardItem = ({item, navigation}) => {
  ...
  return (
    <Card
      ...
      onPress={() => navigation.navigate('PlaceRouteItem', {item: item})}>
